...
maven_install(
    ...
    artifacts = [
        ...
        # To match Maven's behavior the resolver should not error when there is an artifact
        # that is not found, only print a warning
        "com.example:artifact-that-does-not-exist:1.0",
    ],
    fail_if_repin_required = True,
    generate_compat_repositories = True,
